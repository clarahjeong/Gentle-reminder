...
Each time you get to your verses, the app saves that day's feeling and what you asked to hear. If you check in more than once in a day, the latest one counts. Tap **Your month** to see a holographic image of the month at the top. It blends every feeling's color, and the feeling you picked most often takes up the most space. A caption sums up the month, like "Mostly started the day feeling excited", and you can save the image as a picture (PNG) or a 6-second video with the save button in its bottom-right corner. On a phone, saving opens the share sheet, where you can choose Save Image or Save Video. Below it is a calendar with each day colored by feeling. Tap a day to see what you picked. You can change or remove any day, and add a check-in for a past day you missed. You can't check in for future days.
